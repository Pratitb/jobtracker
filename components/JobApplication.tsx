...
const JobApplication = ({ logo, role, org, status, date }: JobApplicationProps) => {

    const logoSize = 40
    return (
        <div className='border-b border-b-border last-of-type:border-none flex justify-between items-start gap-4 py-3'>
